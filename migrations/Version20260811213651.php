 ...
 */
final class Version20260811213651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__supply_request AS SELECT id, title, site, quantity, unit, priority, created_at, delivery_time_start, delivery_time_end, unloading_equipment, calculation_result FROM supply_request');
        $this->addSql('DROP TABLE supply_request');
        $this->addSql('CREATE TABLE supply_request (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, site VARCHAR(255) NOT NULL, quantity DOUBLE PRECISION NOT NULL, unit VARCHAR(50) NOT NULL, priority VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL, delivery_time_start VARCHAR(10) DEFAULT NULL, delivery_time_end VARCHAR(10) DEFAULT NULL, unloading_equipment VARCHAR(50) DEFAULT NULL, calculation_result CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO supply_request (id, title, site, quantity, unit, priority, created_at, delivery_time_start, delivery_time_end, unloading_equipment, calculation_result) SELECT id, title, site, quantity, unit, priority, created_at, delivery_time_start, delivery_time_end, unloading_equipment, calculation_result FROM __temp__supply_request');
